@php
		...
		$method = Str::camel(sprintf('%s_relationship', $row->field));		// for example:  subcategoriaIdRelationship
	...
	@if ( method_exists($model, $method) )
		...
		@php 
			...
			$data = App\Models\Category::parentIdRelationship($dataTypeContent->id);
		...
		@if ( !empty($data) )
			...
			<div class="{{ $css }}" style="padding: 10px;">
				...
				@if(\App\Models\Category::find($key)->parent_id == null)
