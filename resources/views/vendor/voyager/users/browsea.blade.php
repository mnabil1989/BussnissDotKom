                            ...
                            <table id="dataTable" class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        @php
                                        $storeonly = array("City", "Store Name", "Address","Logo","About Store","Country Id","Country");
                                    @endphp
                                ...
                                <tbody>
                                    ...
                                    @if ( App\Models\User::where('type',0)->find($data->getKey()) )
                                    ...
                                    <tr>
                                        ...
                                        @foreach($dataType->browseRows as $row)
                                            ...
                                            @endphp
                                                ...
                                                @if(property_exists($row->details, 'user') && $row->details->user == 'show'  || $row->type == 'timestamp' ||$row->type == 'relationship' && $row->details->model != 'App\\Models\\Country' )
