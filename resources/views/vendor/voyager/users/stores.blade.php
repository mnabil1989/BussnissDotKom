                            ...
                            <table id="dataTable" class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        @php
                                        $storeonly = array("First Name","Last Name","Role", "Verify Code","Country Id","Name","Avatar");
                                    @endphp

                                       @if (!in_array($row->display_name, $storeonly))
                                        <th>
                                            @if ($isServerSide)
                                ...
                                <tbody>
                                    ...
                                    @if ( App\Models\User::where('type',1)->find($data->getKey()) )
                                    ...
                                    <tr>
                                        ...
                                        @foreach($dataType->browseRows as $row)
                                            ...
                                            @endphp
                                                ...
                                                @if(property_exists($row->details, 'store') && $row->details->store == 'show' || $row->type == 'relationship' && $row->details->model == 'App\\Models\\Country' || $row->type == 'timestamp')
